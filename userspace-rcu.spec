...
Source0  : https://www.lttng.org/files/urcu/userspace-rcu-0.15.1.tar.bz2
Source1  : https://www.lttng.org/files/urcu/userspace-rcu-0.15.1.tar.bz2.asc
...
%setup -q -n userspace-rcu-0.15.1
cd %{_builddir}/userspace-rcu-0.15.1
pushd ..
cp -a userspace-rcu-0.15.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739988550
