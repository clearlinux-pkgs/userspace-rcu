...
Source0  : https://www.lttng.org/files/urcu/userspace-rcu-0.14.1.tar.bz2
Source1  : https://www.lttng.org/files/urcu/userspace-rcu-0.14.1.tar.bz2.asc
Source2  : 17280A9781186ACF.pkey
Summary  : A userspace RCU (read-copy-update) library, signal version
...
%setup -q -n userspace-rcu-0.14.1
cd %{_builddir}/userspace-rcu-0.14.1
pushd ..
cp -a userspace-rcu-0.14.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724884417
...
/V3/usr/lib64/liburcu-signal.so.8.1.0
