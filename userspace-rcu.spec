...
Source0  : https://www.lttng.org/files/urcu/userspace-rcu-0.15.3.tar.bz2
Source1  : https://www.lttng.org/files/urcu/userspace-rcu-0.15.3.tar.bz2.asc
...
%setup -q -n userspace-rcu-0.15.3
cd %{_builddir}/userspace-rcu-0.15.3
pushd ..
cp -a userspace-rcu-0.15.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747336896
